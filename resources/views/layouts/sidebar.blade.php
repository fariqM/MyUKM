        ...
        <ul class="childNav" data-parent="dashboard">
            <li class="nav-item ">
                <a class="{{ Route::currentRouteName()=='dashboard_version_1' ? 'open' : '' }}" href="#">
                    <i class="nav-icon i-File-Clipboard-File--Text"></i>
                    <span class="item-name">Layanan 1</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="#" class="{{ Route::currentRouteName()=='dashboard_version_2' ? 'open' : '' }}">
                    <i class="nav-icon i-File-Clipboard-File--Text"></i>
                    <span class="item-name">Layanan 2</span>
                </a>
            </li>
            <li class="nav-item">
        ...
        <ul class="childNav" data-parent="uikits">
            ...
            <li class="nav-item">
                <a class="{{ Route::currentRouteName()=='typography' ? 'open' : '' }}" href="#">
                    ...
                    <span class="item-name">Riwayat hutang kwkwkwk</span>
                </a>
            </li>
