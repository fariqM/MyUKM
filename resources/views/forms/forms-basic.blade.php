    ...
    <div class="col-md-12">
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="row">
                    <form method="POST" class="needs-validation" novalidate action="/docs/store"
            ...
            <div class="card-body">
                ...
                <form ">
                    ...
                    <div class="col-md-6 form-group mb-3">
                        ...
                        <input type="text" class="form-control form-control-rounded" id="firstName2"
                            placeholder="Enter your first name">
                    </div>

                    <div class="col-md-6 form-group mb-3">
                        <label for="lastName2">Last name</label>
                        <input type="text" class="form-control form-control-rounded" id="lastName2"
                            placeholder="Enter your last name">
                    </div>

                    <div class="col-md-6 form-group mb-3">
                        <label for="exampleInputEmail2">Email address</label>
                        <input type="email" class="form-control form-control-rounded" id="exampleInputEmail2"
                    ...
                    <div class="col-md-6 form-group mb-3">
                        ...
                        <div class="input-group">
                            <input id="picker2" class="form-control form-control-rounded" placeholder="yyyy-mm-dd"
                                name="dp">
                            <div class="input-group-append">
