...
<div class="row mb-3">
    <div class="col-md-12">
        <h2>Toastr</h2>
        <p>Toastr is a Javascript library for non-blocking notifications. jQuery is required. The goal is to create a
            simple core library that can be customized and extended.</p>
    </div>
</div>
<div class="row mb-4">
    ...
    <div class="col-md-6 mb-4">
        <div class="card">
            ...
            <div class="card-body">
                <button id="toast-success" class="btn btn-block btn-outline-success btn-success">success
                    toaster</button>
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <button id="toast-warning" class="btn btn-block btn-outline-warning btn-warning">warning
                    toaster</button>
    ...
    <div class="col-md-6 mb-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <button id="toast-position-top-center" class="btn btn-block btn-outline-info btn-info">Top
                    Center</button>
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <button id="toast-position-bottom-left" class="btn btn-block btn-outline-info btn-info">bottom
                    Left</button>
                <button id="toast-position-bottom-center" class="btn btn-block btn-outline-info btn-info">bottom
                    Center</button>
                <button id="toast-position-bottom-right" class="btn btn-block btn-outline-info btn-info">bottom
                    Right</button>
                <button id="toast-position-bottom-full" class="btn btn-block btn-outline-info btn-info">bottom
                    Full</button>
    ...
    <div class="col-md-6 mb-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <button id="toast-close-button" class="btn btn-block btn-outline-success btn-success">Show
                    Toast</button>
    ...
    <div class="col-md-6 mb-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <button id="toast-progress-bar" class="btn btn-block btn-outline-warning btn-warning">Show
                    Toast</button>
    ...
    <div class="col-md-6 mb-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <button id="toast-fast-duration" class="btn btn-block btn-outline-info btn-info mb-3">Show Fast
                    Toast</button>
    ...
    <div class="col-md-6 mb-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p>Hide can be define by <code>hideDuration</code> to set what amount of time will take to hide message
                </p>

                <button id="toast-slow-duration" class="btn btn-block btn-outline-info btn-info mb-3">Hide
                    Toast</button>
