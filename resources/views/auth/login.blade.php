@extends('layouts.app', ['class' => 'login-page', 'page' => __('Gerbang masuk Admin'), 'contentClass' => 'login-page'])

@section('content')
    <div class="col-md-10 text-center ml-auto mr-auto">
        <h3 class="mb-5">Sebelum Login bacalah basmalah biar works :)</h3>
    </div>
        ...
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-white">
                ...
                <div class="card-body">
                    ...
                    <p class="text-dark mb-2" style="text-align:center; font-size: 150%; font-weight: bold;">بِسْمِ اللهِ الرَّحْمٰنِ الرَّحِيْمِ </p>
