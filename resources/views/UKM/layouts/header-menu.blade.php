    <div class="main-header" >
            ...
            <div class="header-part-right">
                ...
                <div class="dropdown widget_dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <div class="menu-icon-grid">
                            ...
                            <a href="#"><i class="i-Drop"></i> Maintenance</a>
                ...
                <!-- Notificaiton -->
                <div class="dropdown">
                    <div class="badge-top-container" style="pointer-events:none;" role="button" id="dropdownNotification" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
